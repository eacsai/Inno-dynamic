...
class MinaWebpackPlugin {
  constructor(options = {}) {
    this.scriptExtensions = options.scriptExtensions || ['.ts', '.js', '.jsx']
    this.assetExtensions = options.assetExtensions || ['.scss']
    this.entries = []
  }
    ...
    compiler.hooks.compilation.tap('MinaWebpackPlugin', compilation => {
      compilation.hooks.beforeChunkAssets.tap('MinaWebpackPlugin', () => {
        compilation.chunks.forEach(chunk => {
          if (chunk.name&&chunk.name.includes(assetsChunkName)) {
